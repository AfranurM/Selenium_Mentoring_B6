...
public class _3_CountJavaWords {

    //    Return the number of times that the string "java" appears anywhere in the given string, except we'll accept any letter for the 'v', so "jaba" and "jaxa" count.
//
//
